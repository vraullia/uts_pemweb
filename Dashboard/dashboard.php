        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <button class="btn btn-primary">
                            <a href=" /UTS3/Lihat_Data/tabel_a.php" data-toggle="tooltip" class="daftar"><i class="material-icons">&#xE417;</i>Lihat Daftar</a>
                        </button>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-primary">
                            <a href=" /UTS3/Lihat_Data/tabel_b.php" data-toggle="tooltip" class="daftar"><i class="material-icons">&#xE417;</i>Lihat Daftar</a>
                        </button>
                        <button class="btn btn-success">
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-primary">
                            <a href=" /UTS3/Lihat_Data/tabel_c.php" data-toggle="tooltip" class="daftar"><i class="material-icons">&#xE417;</i>Lihat Daftar</a>
                        </button>
                        <button class="btn btn-success">
